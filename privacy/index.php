                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="all-news-block">
                            ...
                            <div class="all-news">
                                <h3>Siapa kami</h3>
                                <p>Alamat situs web kami adalah: https://www.mediakarta.com.</p>
                                ...
                                <p>Jika Anda meninggalkan komentar, metadatanya disimpan tanpa batas. Ini agar kami dapat mengenali dan menyetujui komentar tindak lanjut secara otomatis dan tidak menahannya dalam antrean moderasi.</p>
                                <p>Untuk pengguna yang mendaftar pada website kami (jika ada), kami juga menyimpan informasi pribadi yang mereka berikan dalam profil pengguna mereka. Semua pengguna dapat melihat dan mengedit informasi pribadi mereka kapan saja (kecuali mengubah nama pengguna). Administrator situs juga dapat melihat dan mengedit informasi tersebut.</p>
                                
                                <h3>Hak apa yang Anda miliki atas data Anda</h3>
